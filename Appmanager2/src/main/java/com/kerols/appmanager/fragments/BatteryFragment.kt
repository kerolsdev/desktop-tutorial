...
import com.kerols.appmanager.adapters.AdapterBattery
import com.kerols.appmanager.databinding.FragmentBatteryBinding
import com.kerols.appmanager.dialogs.BottomDialogFilterBattery
...
public class BatteryFragment() : Fragment(), BottomDialogFilterBattery.ClickFilterBattery {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapterBattery = AdapterBattery(ArrayList(),requireContext())
        ...
        if (queryUsageStats.isEmpty()) {
            ...
            for (usageStats in usageStatsList) {
                ...
                try {
                    ...
                    val usageStatDTO =
                        App(icon!!, appName, usagePercentage, usageDuration, usageStats.packageName)
