...
object Values {
    ...
    const val NETWORK_SIGNAL_CHANNEL_ID = "LiveNetwork.Notifications"
    ...
    const val DATA_USAGE_WEEKDAY = 0x00D4
    ...
    const val DATA_PLAN_FRAGMENT = 0x0118
    const val APP_CONTRIBUTORS_FRAGMENT = 0x0122
    ...
    const val DATA_RESET_CUSTOM_DATE_START_HOUR = "custom_start_hour"
    const val DATA_RESET_CUSTOM_DATE_START_MIN = "custom_start_min"
    const val DATA_RESET_CUSTOM_DATE_END_HOUR = "custom_end_hour"
    const val DATA_RESET_CUSTOM_DATE_END_MIN = "custom_end_min"
    ...
    const val ALARM_PERMISSION_DENIED = "alarm_permission_denied"
    const val UPDATE_NOTIFICATION_CHANNEL = "update_notification_channel.v2"
    const val SHOULD_SHOW_BATTERY_OPTIMISATION_ERROR = "show_battery_optimisation_error"
    ...
    const val EXTRA_ACTIVITY_TITLE = "datamonitor.intent.extra.activityTitle"
    const val EXTRA_WEEK_DAY = "datamonitor.intent.extra.weekDay"
    const val EXTRA_IS_WEEK_DAY_VIEW = "datamonitor.intent.extra.isWeekDayView"
    const val EXTRA_DATA_ALARM_RESET = "datamonitor.intent.extra.dataAlarmReset"
    ...
    const val WALL_OF_THANKS_LAST_UPDATE = "wall_of_thanks_last_update"
    const val WALL_OF_THANKS_FEATURED_DONORS = "wall_of_thanks_featured_donors"
    const val WALL_OF_THANKS_ALL_DONORS = "wall_of_thanks_all_donors"
}