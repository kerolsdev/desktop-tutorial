...
import com.kerolsmm.incognitopro.databinding.FragmentDownloadListBinding;
import com.kerolsmm.incognitopro.databinding.FragmentProgressDownloadBinding;
...
try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                pdfUri = FileProvider.getUriForFile(requireActivity(),"com.kerolsmm.incognitopro.provider" , new File(fileModel.getPath()));
