...
import com.kerolsmm.incognitopro.BuildConfig;
import com.kerolsmm.incognitopro.Fragments.AccessibilityDialog;
import com.kerolsmm.incognitopro.Fragments.DownloadRequestDialog;
import com.kerolsmm.incognitopro.R;
import com.kerolsmm.incognitopro.Utilts.SettingValue;
import com.kerolsmm.incognitopro.Utilts.StaticValue;
import com.kerolsmm.incognitopro.databinding.ActivitySettingBinding;
...
*/
        ...
        if (settingValue.isAdsBlock()) {
            binding.Adblock.setChecked(true);
        } else  {
            binding.Adblock.setChecked(false);
        }

        binding.Adblock.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                settingValue.setAdsValue(b);
