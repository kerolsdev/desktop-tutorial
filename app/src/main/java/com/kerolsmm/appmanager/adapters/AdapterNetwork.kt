...
class AdapterNetwork(val context: Context, private val clickNetwork: ClickNetwork,
    ...
    override fun onBindViewHolder(holder: ViewModel, position: Int) {
        ...
        try {
            if (model.packageName == "com.android.tethering") {
                ...
                holder.mAppIcon.setImageResource(R.drawable.trash_basket_svgrepo_com)
            } else {
        ...
        holder.mAppName.text = appNameUser
