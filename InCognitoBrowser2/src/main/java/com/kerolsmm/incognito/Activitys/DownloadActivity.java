...
import com.kerolsmm.incognito.DownloaderApp.DownloaderTabs;
import com.kerolsmm.incognito.DownloaderApp.MimeUtils;
...
*/
       ...
       /* boundServiceConnection = new ServiceConnection() {
        ...
        }, DownloadActivity.this , Lifecycle.State.RESUMED);
        ...
        if (Position.getItemId() == R.id.delete_download){
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    pdfUri = FileProvider.getUriForFile(this,"com.kerolsmm.incognito.provider" , new File(fileModel.getPath()));
                    grantUriPermission(getPackageName(), pdfUri, Intent.FLAG_GRANT_READ_URI_PERMISSION | Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
    ...
    private void openFile (String mimeType) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            try {
                ...
                grantUriPermission(getPackageName(), apkURI, Intent.FLAG_GRANT_READ_URI_PERMISSION | Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
