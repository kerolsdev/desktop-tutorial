...
import com.kerolsmm.incognito.Activitys.BookmarkActivity;
import com.kerolsmm.incognito.Activitys.DownloadActivity;
import com.kerolsmm.incognito.Activitys.Home;
import com.kerolsmm.incognito.Activitys.SettingActivity;
import com.kerolsmm.incognito.Data.AppExecutors;
import com.kerolsmm.incognito.Data.BookMark;
...
public class More {
    ...
    public void setPopUpWindow(LayoutInflater layoutInflater, Data_name data_name , boolean isHide , ActivityHomeBinding binding) {
        ...
        TextView Pro = view.findViewById(R.id.upgrade_to_pro);
        ...
        Pro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    home.startActivity(myAppLinkToMarket);
                } catch (ActivityNotFoundException e) {
                    Toast.makeText(home, " unable to find market app", Toast.LENGTH_LONG).show();
                }
            }
        });
            ...
            public void onClick(View v) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                    if (ActivityCompat.checkSelfPermission(home, Manifest.permission.POST_NOTIFICATIONS) != PackageManager.PERMISSION_GRANTED )  {
                        ...
                        DownloadModel downloadModel = new DownloadModel("text/html",url,"attachment",filename);
  ...
  public   interface  onFindPage {
    ...
    public  void createShortcut(@NonNull Activity activity,
        ...
        shortcutIntent.setClassName("com.kerolsmm.incognito","com.kerolsmm.incognito.Activitys.Home");
